  ...
  return (
    <div>
      ...
      <div className='topic'>
        ...
        >
          <div className="slide">
            <img src={catagory} alt='categorized' className="slide-image" data-aos="fade-right" style={{ padding: "40px", width: "700px", height: "400px" }}></img>
          </div>
          <div className="slide">
            <img src={best12} alt='categorized' className="slide-image" data-aos="fade-right" style={{ padding: "40px", width: "700px", height: "400px" }}></img>
          </div>
          <div className="slide">
            <img src={best14} alt='categorized' className="slide-image" data-aos="fade-right" style={{ padding: "40px", width: "700px", height: "400px" }}></img>
          </div>
          <div className="slide">
            <img src={delicious} alt='categorized feedbacks' className="slide-image" style={{ padding: "30px", width: "700px", height: "380px" }} ></img>
          </div>
          <div className="slide">
            <img src={best16} alt='categorized' className="slide-image" data-aos="fade-right" style={{ padding: "40px", width: "700px", height: "400px" }}></img>
          </div>
          <div className="slide">
            <img src={categorized} alt='categorized feedbacks' className="slide-image" style={{ padding: "30px", width: "700px", height: "380px" }} ></img>
          </div>
          <div className="slide">
            <img src={catagory} alt='categorized' className="slide-image" data-aos="fade-right" style={{ padding: "40px", width: "700px", height: "400px" }}></img>
          </div>
      ...
      <div className='satisfaction'>
        <label data-aos="fade-right" data-aos-delay="150" style={{ padding: '40px' }}>So, whether you're craving a sizzling steak, a vibrant vegetarian delight,<br/> beauFoodDelivery with the An AiFilter model is here to fulfill your<br/> Join us on this extraordinary culinary journey,<br/> where innovation meets flavor, and satisfaction knows no bounds.</label>
        <img data-aos="fade-left" data-aos-delay="150" src={pizzfeature} alt='pizza' style={{ width: '600px', height: '500px' }}></img>
      </div>
      <div>
        <label style={{fontSize:"40px", marginLeft:"500px",fontFamily:"sans-serif"}}>We avoid any late Delivery</label>
      </div>
      <div className='file'>
        <img data-aos="fade-right" data-aos-delay="150" src={Foodengine} alt='chicken' style={{ width: '600px', height: '500px', marginLeft: '70px' }}></img>
      ...
      <div className='satisfaction'>
        ...
        <img data-aos="fade-left" data-aos-delay="150" src={feedback2} alt='order' style={{ width: '600px', height: '500px' }}></img>
      </div>
